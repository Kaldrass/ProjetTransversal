...
def main(image):
    ...
    resized = imutils.resize(image, width=300)  # utiliser cv2
    ...
    cnts = imutils.grab_contours(cnts)  # ca je sais pas
    sd = ShapeDetector()
